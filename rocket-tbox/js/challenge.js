...
export function confirmExitChallenge() {
    return window.confirm(
        '¿Salir del modo desafío?\n\n' +
        'Esto restaurará tu cohete al diseño Falcon-9 por defecto y los ajustes de simulación normales (control por velocidad de giro, sin fuerzas aerodinámicas, solo avisos estructurales).'
    );
}
